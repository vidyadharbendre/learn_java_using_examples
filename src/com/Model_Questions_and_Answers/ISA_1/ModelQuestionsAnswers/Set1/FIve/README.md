...
This Java code demonstrates the concept of inheritance through a superclass `Vehicle` and its subclasses `Car` and `Motorcycle`.
...
public class InheritanceExample {
    public static void main(String[] args) {
        ...
        Car carObj = new Car("Toyota", "Camry", 2022, 4);
        Motorcycle motorcycleObj = new Motorcycle("Honda", "CBR500R", 2021, "Sport");
