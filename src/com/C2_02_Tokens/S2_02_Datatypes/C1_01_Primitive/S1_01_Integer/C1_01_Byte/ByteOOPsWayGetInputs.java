...
public class ByteOOPsWayGetInputs {
    ...
    public static void main(String[] args) {
        ...
        Scanner inputObj1;
        inputObj1 = new Scanner(System.in);



        ByteOOPsWayGetInputs objByteOOPs1;
        objByteOOPs1 = new ByteOOPsWayGetInputs((byte)10);

        // Displaying information for each instance
        System.out.println("Byte Example in Stack Memory - (Quantity initilized with 10): " + objByteOOPs1.getQuantity());

        System.out.println("Enter quantity as Byte datatype\n");
        quantity = inputObj1.nextByte();

        objByteOOPs1.setQuantity(quantity);
        System.out.println("Byte Example in Stack Memory - (Quantity taken from keyboard): " + objByteOOPs1.getQuantity());

        objByteOOPs1.displayBinaryRepresentation();
        objByteOOPs1.displayByteDataTypeSize();

        ByteOOPsWayGetInputs objByteOOPs2;
        objByteOOPs2 = new ByteOOPsWayGetInputs((byte)30);
...
/*
javac -d ../../../../../../../out ByteOOPsWayGetInputs.java
*/
